...
//mascotas
Route::get('/mascotas/register/{key}',[KeysController::class, 'getKey' ])->name('vermascota');
Route::post('/mascotas/ubicacion',[MascotasController::class, 'enviarUbicacion' ])->name('ubicacion');
